...
class GoToPose():
    def __init__(self):
        ...
        self.kcf_cmd_vel_pub = rospy.Publisher('/kcf_cmd_tracker', Twist, queue_size=5)
###################################################################################################
...
###################################################################################################
	...
	#rospy.on_shutdown(self.shutdown)
        ...
        rospy.loginfo("Starting the config")
	...
	self.move_base.wait_for_server(rospy.Duration(5))
        rospy.loginfo("Starting the processing")
...
###################################################################################################        
    ...
    def voice_command_callback(self, msg):
        ...
        print(position)
        print(quaternion)
        self.kcf_cmd_vel_pub.publish(self.cmd_vel)
